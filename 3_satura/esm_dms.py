...
"""
Script modify from (https://huggingface.co/blog/AmelieSchreiber/mutation-scoring)
...
def create_parser():
    ...
    parser.add_argument("--scoring-strategy", type=str, default="wt-marginals", choices=["wt-marginals", "masked-marginals"], help="")
